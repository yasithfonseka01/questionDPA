    ...
    public partial class MainWindow : Form
    {
        ...
        private void answerCheck(Button selectedOption)
        {
            ...
            if (currentQuestion.checkAnswer(selectedOption.Text))
            {
                ...
                string buttonName = "prize" + questionNo;
                ...
                else
                {
                    ...
                    MessageBox.Show($"Button {buttonName} not found or not of type Button.");
                }
            ...
            else
            {
                ...
                if (controls.Length > 0 && controls[0] is Button button2)
                {
        ...
        {
            usrId.Text = "USER ID : " + uid.ToString();

            //string dd = usrId.Text;

            //DatabaseHelper userid = new DatabaseHelper();
            //int usId = int.Parse(dd);
            //userid.Usr_id(uid);
        }
    }
